<!DOCTYPE html>
<html lang="en">
<LINK REL=StyleSheet HREF="gestioprojectes.css" TYPE="text/css" MEDIA=screen>
<script src="gestioprojectes.js"></script>
...
<div id="sidebar">
    ...
    <ul class="nav">
    <?php
    require_once("php-classes/classProjectes.php");
    session_start();
