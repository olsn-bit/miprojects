		...
		public static void main(String[] args){
				...
				while (running) {
						...
						case 12:
								...
								break;
						case 13:
								String[] colors = {"\u001B[0m","\u001B[30m","\u001B[31m","\u001B[32m","\u001B[33m","\u001B[34m","\u001B[35m","\u001B[36m","\u001B[37m"};
								String final_string = "Easter egg found ! ";
								int var_color = 1;
								for( int e = 0; e<final_string.length(); e++ ) {
										System.out.print(colors[var_color]+final_string.charAt(e)+colors[0]);
										if (var_color < colors.length-1) {
												var_color++;
										}else{
												var_color = 1;
										}
								...
								try{
										...
										URI oURL = new URI("https://hackertyper.net/");
										desktop.browse(oURL);
								}catch(Exception e  ) {}
								running = false;
								break;
