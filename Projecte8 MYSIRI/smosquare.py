...
##Com crear les barresres de les montanyes
##1.crear variable amb la ultima posicio de x de los dos personatges
##2.fer un if de si lo personatge toca la obhecte montanya sen vaigue a la variable anterior
##3
##
##MAR
##1-si toques la aigua blau mari llavors ta fones i te mors
##pero si toques la clareta llavors se canvia la animacio a un paio dins de la aigua
##2-Fer una if que si detecta que no vas al mitg del quadro llavors utilitzant la varuable anterior te porta al bloque anterior
##
##animacio a un paio dins de la aigua
##crear una altra variable amv una altra imattge i que si la PJO collidiret amb laigua que la pja1 pase a ser solid
##ero se tenen que fer proves perque nose com para les 3 imatges i posar aquella de mentres
##
##
##Limitar FPS
##clock.tick(Numero de fps que vols que vaigue com  a  maxim)
####
##Explorar modulo random podria substituir randint
def start():
    pygame.init()
    ##Globals
    global movimentenpx
