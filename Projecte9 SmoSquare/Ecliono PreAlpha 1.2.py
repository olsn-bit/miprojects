...
pygame.display.set_caption('Ecliono alpha1.2')
...
while True:
    ...
    while gamestart:
        ...
        #print(temsrandom,habilitatqtirada)
        ...
        if pygame.key.get_pressed()[pygame.K_q]:
                ...
                if Energia < 30:
                    ...
                    PXH3 = -1200
                    PXH4 = -1200
                    Energia -= 30#deuria ser 30 pero esta desactivat per a admin
